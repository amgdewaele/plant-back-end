...
describe('Creating plants in the database', () => {
    ...
    beforeEach(() => {
        ...
        existingPlantList = new PlantList(PlantListFactory.generate);
        currentUser.save()
            .then(() => {
    ...
    it('Create a users plant list', () => {
        let newPlantlist = new PlantList(PlantListFactory.generate);
    ...
    it('Add a plant to the PlantList', () => {
